---
title: "Try to fit polynoimal model"
date: 2019-1-31
output: pdf_document
---
...
#### K means to cluster the covariates
...
y = y[1] + new_x* y[2] + new_x^2 * y[3] + new_x^3* y[4] #+ new_x^4 * y[5]+ 
  #new_x^5 * y[6]
plot(new_x[,1],y[,1],type ='l', col = 2, main= 'plot for cluster 2')

```


#### The summary of number of clusters 
...
kable(cluster_summary_table(km_plm,merged))
```